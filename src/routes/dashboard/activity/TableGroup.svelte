<script lang="ts">
	...
	import { type InvoiceDriver, type InvoiceAccount, type InvoiceReportType } from '$lib/data';
	import type { AccountAPI } from '$lib/account';
	import type { FinanceReportType } from '$lib/financeStore';
		...
		{#each invoices as invoice, i (i)}
			<Table.Row>
				{#each headings as heading, i}
					{#if page.url.href.includes('account')}
